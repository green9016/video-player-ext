...
:doit
if /i "%1#" == "--libs#"    echo -L/home/osboxes/Documents/vlc-3.0/contrib/i686-w64-mingw32/lib -llibtag
if /i "%1#" == "--cflags#"  echo -I/home/osboxes/Documents/vlc-3.0/contrib/i686-w64-mingw32/include/taglib
if /i "%1#" == "--version#" echo 1.11
if /i "%1#" == "--prefix#"  echo /home/osboxes/Documents/vlc-3.0/contrib/i686-w64-mingw32
