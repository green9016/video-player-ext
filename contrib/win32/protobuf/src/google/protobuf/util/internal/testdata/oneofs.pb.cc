...
void protobuf_AssignDesc_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto() {
  ...
  RequestWithSimpleOneof_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      RequestWithSimpleOneof::default_instance_,
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RequestWithSimpleOneof, _is_default_instance_));
  ...
  MoreData_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MoreData, _is_default_instance_));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      RequestWithSimpleOneof_descriptor_, &RequestWithSimpleOneof::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      Data_descriptor_, &Data::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      MoreData_descriptor_, &MoreData::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto() {
  ...
  delete RequestWithSimpleOneof::default_instance_;
  ...
  delete MoreData::default_instance_;
...
void OneOfsRequest::InitAsDefaultInstance() {
  ...
  OneOfsRequest_default_oneof_instance_->more_data_ = const_cast< ::google::protobuf::testing::oneofs::MoreData*>(&::google::protobuf::testing::oneofs::MoreData::default_instance());
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(50)) goto parse_struct_data;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_value_data;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_list_value_data;
        break;
      }
...
void RequestWithSimpleOneof::InitAsDefaultInstance() {
  ...
  RequestWithSimpleOneof_default_oneof_instance_->message_data_ = const_cast< ::google::protobuf::testing::oneofs::Data*>(&::google::protobuf::testing::oneofs::Data::default_instance());
  RequestWithSimpleOneof_default_oneof_instance_->more_data_ = const_cast< ::google::protobuf::testing::oneofs::MoreData*>(&::google::protobuf::testing::oneofs::MoreData::default_instance());
}
...
RequestWithSimpleOneof* RequestWithSimpleOneof::default_instance_ = NULL;
...
int RequestWithSimpleOneof::ByteSize() const {
...
MoreData* MoreData::default_instance_ = NULL;
